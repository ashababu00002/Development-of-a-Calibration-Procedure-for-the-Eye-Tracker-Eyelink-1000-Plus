...
% Process subject 4
left_pupil4 = data4.y(45,11520:16320);
right_pupil4 = data4.y(46,26880:31680);
...
% Process subject 5
left_pupil5 = data5.y(45,11520:16320);
right_pupil5 = data5.y(46,26880:31680);
...
% Process subject 6
left_pupil6 = data6.y(45,4800:9600);
...
% Process subject 7
left_pupil7 = data7.y(45,19200:24000);
right_pupil7 = data7.y(46,24000:28800);
...
% Process subject 8
left_pupil8 = data8.y(45,38400:43200);
right_pupil8 = data8.y(46,38400:43200);
...
l           = Area_left;       % creates a 1*22 array with zeros to store distance value of 22 participants


save('pupil_left.mat', 'l');
